  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-12">
            <h5><i class="fa fa-list"></i> Guia de Salida Generadas
              <a href="{{ route('guiasalida.create') }}" class="btn btn-primary btn-sm float-end"><i class="fa fa-plus"></i>
                Nueva</a>
            </h5>
        ...
        <form name="form_busqueda" id="form_busqueda">
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <input class="form-control fecha" data-tipo='inicio' type="date" name="fecha_inicio" id="fecha_inicio"
                value="{{ date('Y-m-d') }}" max="{{ date('Y-m-d') }}">
            </div>
            <div class="col-md-3">
              <label class="form-label">Fecha Fin</label>
              <input class="form-control fecha" data-tipo='fin' type="date" name="fecha_fin" id="fecha_fin"
                value="{{ date('Y-m-d') }}">
            </div>
            <div class="col-md-1">
        ...
        <div class="row mt-4">
          <div class="col-md-6" id="div_loading">
