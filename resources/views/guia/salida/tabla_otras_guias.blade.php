...
<table class="table table-hover table-striped table-sm table-bordered" id="tabla_guias" style="width: 100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="align-middle">{{ "[{$item->cliente_nro_documento}] {$item->cliente_razon_social}" }}</td>
      ...
      <td class="align-middle"><a href="{{ route('guiasalida.pdf', ['guia'=>$item->id, 'valorada' => 1]) }}" class="btn btn-primary btn-xs" target="_blank"><i class="fa fa-external-link"></i> Ver</a></td>
